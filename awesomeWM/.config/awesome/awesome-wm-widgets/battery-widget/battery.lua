...
local function worker(user_args)
    ...
    local awesome_config_icons_path = os.getenv("HOME") .. "/.config/awesome/icons/Arc/status/symbolic/"
--    local path_to_icons = args.path_to_icons or "/usr/share/icons/Arc/status/symbolic/"
    local path_to_icons = args.path_to_icons or awesome_config_icons_path or "/usr/share/icons/Arc/status/symbolic/"
