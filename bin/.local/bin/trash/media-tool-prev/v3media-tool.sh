...
# --- Dependency Check ---
# Removed jhead since rotation features were removed
for cmd in magick webpinfo whiptail; do
...
# --- Main Menu Options ---
show_main_menu() {
    whiptail --title "Image Processing TUI" --menu "Select an operation for: $BASE_NAME" 15 55 3 \
