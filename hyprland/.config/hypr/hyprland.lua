...
hl.animation({ leaf = "workspaces",    enabled = true,  speed = 3.81, bezier = "easeOutQuint", style = "slidevert" })
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 4.00, bezier = "easeOutQuint", style = "slidevert" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 3.81, bezier = "easeOutQuint", style = "slidevert" })
...
hl.config({
    misc = {
        ...
        render_unfocused_fps = 7, -- 15 is default
    },
})
...
-- Note: Vertical movement usually relies on standard Hyprland dispatchers
-- since the scrolling layout handles horizontal logic.
